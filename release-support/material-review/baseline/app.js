...
(() => {
 ...
 const novaCopy={
  likely_other:{title:'A fotó alapján valószínűleg nem NovaLife.',next:'A tisztítás a címke és a helyszíni anyagpróba ellenőrzése után egyeztethető.',quality:'Más szövetre utaló jelek'},
 ...
 function novaPanel(d){
  ...
  panel.append(actions,el('p','A címkét gyakran az ülőlap alatt vagy a bútor alján találod. Ha megvan, a gyártó kezelési útmutatóját is készítsd elő.','eco-material-novalife-tip'));return panel;
 }
