...
if manifest.get('contentClarityOverlay'):
    spec=importlib.util.spec_from_file_location('content_clarity_overlay',ROOT/'release-support/verify-content-clarity-overlay.py')
...
elif manifest.get('englishOverlay'):
    spec=importlib.util.spec_from_file_location('english_overlay',ROOT/'release-support/verify-english-overlay.py')
    overlay_module=importlib.util.module_from_spec(spec);spec.loader.exec_module(overlay_module)
    errors.extend(overlay_module.verify(manifest))
elif manifest.get('priceOverlay'):
    spec=importlib.util.spec_from_file_location('price_overlay',ROOT/'release-support/verify-price-overlay.py')
    overlay_module=importlib.util.module_from_spec(spec);spec.loader.exec_module(overlay_module)
    errors.extend(overlay_module.verify(manifest))
elif manifest.get('bookingExtrasOverlay'):
    spec=importlib.util.spec_from_file_location('booking_extras_overlay',ROOT/'release-support/verify-booking-extras-overlay.py')
    overlay_module=importlib.util.module_from_spec(spec);spec.loader.exec_module(overlay_module)
    errors.extend(overlay_module.verify(manifest))
elif manifest.get('reviewOverlay'):
    ...
    overlay_module=importlib.util.module_from_spec(spec);spec.loader.exec_module(overlay_module)
    errors.extend(overlay_module.verify(manifest))
elif manifest.get('copyOverlay'):
    spec=importlib.util.spec_from_file_location('copy_overlay',ROOT/'release-support/verify-copy-overlay.py')
    overlay_module=importlib.util.module_from_spec(spec);spec.loader.exec_module(overlay_module)
    errors.extend(overlay_module.verify(manifest))
elif manifest.get('widgetOverlay'):
