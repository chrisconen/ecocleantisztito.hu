...
// The demo uses one light palette, irrespective of saved preferences.
...
const menuData = {
    ...
    szonyegtisztitas: {
        ...
        cities: ['Győr', 'Sopron', 'Szombathely', 'Veszprém', 'Tatabánya', 'Komárom', 'Pápa', 'Mosonmagyaróvár', 'Tata', 'Balatonfüred', 'Siófok', 'Keszthely', 'Hévíz', 'Tihany', 'Balatonalmádi', 'Tapolca', 'Révfülöp', 'Badacsony', 'Balatonföldvár', 'Balatonlelle', 'Fonyód', 'Zamárdi', 'Balatonboglár', 'Balatonfűzfő', 'Balatonkenese', 'Balatonszemes']
    },
    takaritas: {
...
function openMegaMenu(menuKey) {
    ...
    megaMenuContent.innerHTML =
        ...
        '<div class="mega-section-label"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"/><circle cx="12" cy="10" r="3"/></svg> Válassz várost</div>' +
