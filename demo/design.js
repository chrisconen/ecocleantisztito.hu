/* Gallery, accessibility, source-photo comparison, and local demo completion. */
(() => {
  'use strict';
  ...
  const enhanceFields=()=>{
    ...
    document.getElementById('configStatus').textContent='● DEMÓ';
  };
  ...
  window.showDemoResult=()=>{
    document.getElementById('demoResultTotal').textContent=`Kalkulált összeg: ${State.totalPrice.toLocaleString('hu-HU')} Ft`;
    result.showModal();
  };
  ...
  // Open the primary furniture selector as a meaningful initial demo state.
